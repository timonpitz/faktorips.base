...
public class DtoMapperFactory implements IIpsArtefactBuilderFactory {

    @Override
    public IIpsArtefactBuilder createBuilder(StandardBuilderSet builderSet) {
        return new DtoMapperClassBuilder(false, builderSet, builderSet.getGeneratorModelContext(),
